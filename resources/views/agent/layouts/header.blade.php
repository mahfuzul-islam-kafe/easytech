                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8 col-sm-8">
                        <div class="header__right p-relative d-flex justify-content-between align-items-center">
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul>
                                        <li class="active"><a href="{{route('agent.index')}}">Home</a></li>
                                            ...
                                            <div class="mini-cart-inner">
                                                <ul class="mini-cart-list">
                                                    <li>
                                                        <div class="cart-img f-left">
                                                            <a href="product-details.html">
                                                                <img src="{{asset('cdn/assets/img/shop/product/cart-sm/16.jpg')}}"
                                                                    alt="" />
                                                            </a>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="cart-img f-left">
                                                            <a href="product-details.html">
                                                                <img src="{{asset('cdn/assets/img/shop/product/cart-sm/17.jpg')}}"
                                                                    alt="" />
                                                            </a>
                                                        </div>
                                                        <div class="cart-content f-left text-left">
                                                    ...
                                                    <li>
                                                        <div class="cart-img f-left">
                                                            <a href="product-details.html">
                                                                <img src="{{asset('cdn/assets/img/shop/product/cart-sm/18.jpg')}}"
                                                                    alt="" />
                                                            </a>
                                                        </div>
                                                        <div class="cart-content f-left text-left">
