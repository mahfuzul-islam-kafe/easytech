...
@section('main')
    ...
    <main>
        ...
        <section class="page__title p-relative d-flex align-items-center" data-background="{{asset('cdn/assets/img/page-title/page-title-1.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <form action="#">
                            <div class="table-content table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="product-thumbnail"><a href="product-details.html"><img src="{{asset('cdn/assets/img/shop/product/product-2.jpg')}}" alt=""></a></td>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="product-details.html"><img src="{{asset('cdn/assets/img/shop/product/product-4.jpg')}}"  alt=""></a></td>
